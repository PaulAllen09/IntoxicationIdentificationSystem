...
public class ShortTimeStart extends AppCompatActivity {
    Thread thread;
    int user_id;
    Intent intent;
    String baseTest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.short_time_start);
        intent = new Intent(ShortTimeStart.this, ShortTimeMemory.class);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                running=false;
                ShortTimeStart.this.startActivity(intent);
            }
        });
    }
}
